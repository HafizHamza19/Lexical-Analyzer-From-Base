            ...
            for (int i = 0; i < item.Length; i++)
            {
                ...
                else if (CheckOperator(item[i].ToString()))
                {
                    ...
                    if (item[i] == '\'')
                    {
                        ...
                        token.Append("\n(literal constant, ").Append(item.Substring(i, j - i + 1)).Append(") ");
                        ...
                        if (item[i] == '"')
                        {
                            ...
                            {
                                if (Parse(item.Substring(0, i + 1)).Contains("\n numerical constant") && item[i + 1] == '.')
                                {
                                    int j = i + 2;
                                    ...
                                    {
                                        token.Append("\n(numerical constant, ").Append(item.Substring(0, j)).Append(") ");
